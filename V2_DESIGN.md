...
## 11. Calendar interchange -- specified, not decided

**ANALYSIS.** `CALENDAR_DESIGN_V2.md` (merged to `main` 2026-08-27; it was
branch-only until then, which is why every pointer to it below and in
`CALENDAR_DESIGN.md` said "on branch") specifies an interchange convention for calendars as Fossil artifacts:
